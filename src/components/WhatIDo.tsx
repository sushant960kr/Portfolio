        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Aspiring developer skilled in Python, web development,
                and cloud technologies, focused on building scalable, 
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Aspiring Cloud Engineer skilled in AWS, DevOps, 
                and automation, building secure, scalable, and
                reliable cloud infrastructure with modern deployment practices.
              </p>
              <h5>Service & tools</h5>
              <div className="what-content-flex">
